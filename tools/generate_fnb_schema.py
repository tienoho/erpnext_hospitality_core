...
SCHEMA = {
 ...
 'FNB Settings': SCOPE + [f('enabled', 'Check', readonly=True),f('paused','Check',readonly=True),f('pause_reason','Small Text',readonly=True), f('cutover_at', 'Datetime'),
 ...
 'FNB Outlet': SCOPE + [f('outlet_name', required=True), link('warehouse', 'Warehouse', required=True),
    link('responsible_user', 'User', required=True), f('enabled', 'Check'),f('paused','Check',readonly=True),f('pause_reason','Small Text',readonly=True), table('pos_profiles','FNB POS Mapping'),
 ...
 'FNB Recipe Version': SCOPE + [f('is_group_template','Check'), link('outlet','FNB Outlet'), link('item','Item',required=True),
    link('template','FNB Recipe Version'),link('supersedes','FNB Recipe Version'),f('import_key',readonly=True,unique=1),f('import_content_hash',readonly=True),
